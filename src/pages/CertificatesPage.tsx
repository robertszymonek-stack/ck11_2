const certificates = [
  {
    brand: "Gree",
    alt: "Certyfikat autoryzacyjny Gree — Robert Szymonek, Robogaz Sp. z o.o.",
    file: "certyfikat-gree.jpg",
  },
  {
    brand: "LG",
    alt: "Certyfikat autoryzowanego instalatora LG — Robert Szymonek, Robogaz Sp. z o.o.",
    file: "certyfikat-lg.jpg",
  },
  {
    brand: "Haier",
    alt: "Certyfikat autoryzowanego punktu serwisowego Haier — Robogaz Sp. z o.o.",
    file: "certyfikat-haier.jpg",
  },
  {
    brand: "Fuji Electric / General",
    alt: "Certyfikat autoryzowanego punktu serwisowego Fuji Electric / General — Robogaz Sp. z o.o.",
    file: "certyfikat-fuji.jpg",
  },
  {
    brand: "AUX / Sevra",
    alt: "Certyfikat autoryzowanego instalatora AUX i Sevra — Robogaz",
      ...
      <section className="bg-slate-950 py-20 text-white lg:py-24">
        <div className="mx-auto max-w-5xl px-5 text-center lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-white/70">
            ...
            firmy Robogaz Sp. z o.o. — operatora CzasKlimy.pl. Każdy certyfikat
